...
public Doctor() {
	...
	public String toString() {
		return  doctorId + " " + specialization + " "
				+ doctorRegistrationCouncil + " " + doctorRegistrationYear
				+ " " + doctorRegistrationNumber + " " + college + " "
				+ degree + " " + yearOfCompletion + " " + yearOfExperiance
				+ " " + establishmentName + " " + establishmentCity
				+ " " + locality + " " + medicalProof + " "
				+ establishmentProof + " " + identityProof ;
	}
